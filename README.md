...
### Результат.
![Меню](https://github.com/illusprite/SoftwareEngineering/blob/Topic_6/pic/1.jpg)
## Выводы
Я поработал с кортежами, ф строками, заполнением списка элементами введённйо строки
...
### Результат.
![Меню](https://github.com/illusprite/SoftwareEngineering/blob/Topic_6/pic/2.jpg)
## Выводы
Я поработал с кортежами, заполнением списка элементами введённйо строки и функциями
...
### Результат.
![Меню](https://github.com/illusprite/SoftwareEngineering/blob/Topic_6/pic/3.jpg)
## Выводы
...
### Результат.
![Меню](https://github.com/illusprite/SoftwareEngineering/blob/Topic_6/pic/4.jpg)
## Выводы
Я поработал с функциями, списками и словарями
...
### Результат.
![Меню](https://github.com/illusprite/SoftwareEngineering/blob/Topic_6/pic/5.jpg)
## Выводы
